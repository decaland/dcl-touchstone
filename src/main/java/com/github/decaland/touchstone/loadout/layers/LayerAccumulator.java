...
public final class LayerAccumulator {
    ...
    private final Finalized finalized = new Finalized();
    private boolean isFinalized = false;
    private LayerNode firstLayer = null;
    private LayerNode lastLayer = null;

    public FinalizedLayers pending() {
        if (isFinalized) {
    ...
    public FinalizedLayers finalized() {
        if (isFinalized) {
    ...
    private final class Finalized implements FinalizedLayers {
